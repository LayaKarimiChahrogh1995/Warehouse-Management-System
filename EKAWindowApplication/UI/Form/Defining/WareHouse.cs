        ...
        public void Bind()
        {
            ...
            rgvList.DataSource = _data.Result
                ...
                .Select(r => new
                {
                   r.WareHouseID,
                   r.Name,
                   AllowSend = r.AllowSend ? @"Yes" : @"No",
                   AllowReceive = r.AllowReceive ? @"Yes" : @"No",
                   ManagerName = (r.User != null) ? r.User.FirstName + " " + r.User.LastName : "No Manager",
                   IsCountable = r.IsCountable ? @"Yes" : @"No",
                }).ToList();
